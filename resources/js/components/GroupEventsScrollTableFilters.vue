<template>
  <div class="gestf-layout pl-2 pr-2">
    <b-form-input
        v-model="searchTitle"
        type="search"
        :placeholder="$translate('events.search_title_placeholder')"
        class="mb-1 mb-md-0 search"
    />
    <multiselect
        v-model="searchCountry"
        :placeholder="$translate('events.search_country_placeholder')"
    ...
    />
    <b-form-datepicker class="datepicker" v-model="searchStart" :placeholder="$translate('events.search_start_placeholder')" @shown="$emit('calendarOpen')" @hidden="$emit('calendarClose')"></b-form-datepicker>
    <b-form-datepicker class="datepicker" v-model="searchEnd" :placeholder="$translate('events.search_end_placeholder')" @shown="$emit('calendarOpen')" @hidden="$emit('calendarClose')"></b-form-datepicker>
  </div>
</template>
<script>
export default {
