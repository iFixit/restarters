<template>
    ...
    <template slot="title">
          <div class="d-flex">
      {{ $translate('microtasking.discussion.title') }}
    ...
    <template slot="content">
      ...
      <div class="content pt-2">
          ...
          <b-thead class="text-center">
            <b-tr class="border-0">
              ...
              <b-th class="d-none d-md-table-cell">
                <b-img class="icon" src="/images/speech_bubble.svg" :title="$translate('microtasking.discussion.number_of_comments')"/>
              </b-th>
              <b-th class="d-none d-md-table-cell">
                <b-img class="icon" height="28px" src="/images/clock.svg" :title="$translate('microtasking.discussion.topic_created_at')"/>
              </b-th>
            </b-tr>
          </b-thead>
          <b-tbody v-if="topics">
        ...
        <div class="text-right pt-0 pb-2 pr-2">
          <a :href="seeAllTopicsLink">{{ $translate('microtasking.discussion.see_all') }}</a>
        </div>
      </div>
    </template>
  </CollapsibleSection>
