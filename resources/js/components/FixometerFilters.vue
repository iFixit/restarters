  ...
  <div>
      ...
      <div :class="{
        ...
        <div class="flex-grow-1">
          <h3 class="text-uppercase header pl-2 mt-3 font-weight-bold text-center">
            {{ $translate('devices.item_and_repair_info') }}
          </h3>
        </div>
      ...
      <b-collapse id="collapse-item" v-model="expandedItems">
        <b-card no-body>
          <b-card-body class="p-2">
            ...
            <div class="w-100 device-select-row">
              <b-form-group :label="$translate('devices.search_assessment_comments')">
    ...
    <div class="border">
      ...
      <b-collapse id="collapse-item" v-model="expandedEvents">
        <b-card no-body>
          <b-card-body class="p-2">
            <b-form-group :label="$translate('devices.group')">
              <b-input v-model="current_group" />
            </b-form-group>
            <b-form-group :label="$translate('devices.from_date')">
            ...
            <b-form-group :label="$translate('devices.to_date')">
