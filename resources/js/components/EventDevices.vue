<template>
  <CollapsibleSection class="lineheight" collapsed :count="deviceCount" always-show-count count-class="text-black font-weight-normal">
    <template slot="title">
      <div class="d-flex">
        <b-img class="d-none d-md-block icon" src="/images/tv.svg" />&nbsp;{{ $translate('devices.title_items_at_event') }}
      </div>
    </template>
        ...
        <b-tabs class="ourtabs ourtabs-brand w-100">
          <b-tab active title-item-class="w-50" class="pt-2">
            <template slot="title">
              <div class="d-flex justify-content-between">
                <div>
                  <b>{{ $translate('devices.title_powered') }}</b> ({{ powered.length }})
                </div>
                <div class="d-flex">
            ...
            <p v-html="$translate('devices.description_powered')" />
            ...
            <b-btn variant="primary" v-if="canedit" class="mb-4 ml-4 add-powered-device-desktop" @click="addPowered($event)">
              <b-img class="icon mb-1" src="/images/add-icon.svg" /> {{ $translate('partials.add_device_powered') }}
            </b-btn>
          ...
          <b-tab title-item-class="w-50" class="pt-2">
            <template slot="title">
              <div class="d-flex justify-content-between">
                <div>
                  <b>{{ $translate('devices.title_unpowered') }}</b> ({{ unpowered.length }})
                </div>
                <div class="d-flex">
                  <div class="mr-3 lower">
                    <b-img src="/images/trash_brand.svg" class="icon" />
            ...
            <p v-html="$translate('devices.description_unpowered')" />
            ...
            <b-btn variant="primary" v-if="canedit" class="mb-4 ml-4 add-unpowered-device-desktop" @click="addUnpowered($event)">
              <b-img class="icon mb-1" src="/images/add-icon.svg" /> {{ $translate('partials.add_device_unpowered') }}
            </b-btn>
