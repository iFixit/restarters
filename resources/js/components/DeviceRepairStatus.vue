<template>
  <div class="mb-2">
    <multiselect
        ...
        :placeholder="$trans.site('devices.repair_outcome')"
    ...
    <multiselect
        ...
        v-if="showSteps"
        v-model="stepsValue"
        :placeholder="$trans.site('devices.repair_details')"
    ...
    <multiselect
        ...
        v-model="partsValue"
        class="spare-parts"
        :placeholder="$trans.site('devices.spare_parts')"
    ...
    <multiselect
        ...
        :placeholder="$trans.site('partials.choose_barriers')"
