...
class Group extends Model implements Auditable
{
    ...
    {
        return $this->belongsToMany(\App\Models\GroupTags::class, 'grouptags_groups', 'group', 'group_tag');
    }
    ...
    {
        return $this->hasOne(\App\Models\Xref::class, 'reference', 'idgroups')->where('reference_type', env('TBL_GROUPS'))->where('object_type', 5);
    }

    public function allHosts(): HasMany
    {
        return $this->hasMany(\App\Models\UserGroups::class, 'group', 'idgroups')->where('role', Role::HOST);
    }

    public function allRestarters(): HasMany
    {
        return $this->hasMany(\App\Models\UserGroups::class, 'group', 'idgroups')->where('role', Role::RESTARTER);
    }

    public function allVolunteers(): HasMany
    {
        return $this->hasMany(\App\Models\UserGroups::class, 'group', 'idgroups')->orderBy('role', 'ASC');
    }
    ...
    {
        return \App\Models\Party::getEventStatsArrayKeys() + ['parties' => 0];
    }
    ...
    public function getGroupStats($eEmissionRatio = null, $uEmissionratio = null)
    {
        ...
        $result = \App\Models\Party::getEventStatsArrayKeys();
     ...
     *
     * @param \App\Models\User $volunteer A registered user.
     */
     ...
     *
     * @param App\Models\User $groupVolunteer A user who is already a member of the group.
     */
