...
class Party extends Model implements Auditable
{
    ...
    {
        return $this->hasMany(\App\Models\Device::class, 'event', 'idevents')->join('categories', 'categories.idcategories', '=', 'devices.category');
    }

    public function allInvited(): HasMany
    {
        return $this->hasMany(\App\Models\EventsUsers::class, 'event', 'idevents')->where('status', '!=', 1);
    }
    ...
    {
        return $this->hasOne(\App\Models\Group::class, 'idgroups', 'group');
    }
    ...
    {
        return $this->hasMany(\App\Models\Device::class, 'event', 'idevents');
    }
